...
public class Gmail_Login_With_Sendkeys 
{
	...
	public static void main(String[] args) throws Exception 
	{
		...
		//Type text into Email editbox and press Enter key
		driver.findElement(By.id("identifierId")).clear();
		driver.findElement(By.id("identifierId")).sendKeys("qadarshan"+Keys.ENTER);
		
		Thread.sleep(5000);   //Static timegap to load passwrod page
		
		//Type Text into password editbox and press enter key
